...
public class ConcretePowderStairsBlock extends StairsBlock implements CustomConcretePowderBlock {
    ...
    public ConcretePowderStairsBlock(Block concrete, BlockState blockState, Settings properties) {
