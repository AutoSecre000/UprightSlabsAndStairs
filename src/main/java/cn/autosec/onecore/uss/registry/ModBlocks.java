...
public class ModBlocks {
    ...
    public static List<BlockLib> getBlockLib() {
        if (blockLib.isEmpty()) {
            ...
            blockLib.add(new BlockLib(OXIDIZED_CUT_COPPER_UPRIGHT_SLAB, "oxidized_cut_copper_upright_slab").locale("Oxidized Cut Copper Upright Slab", "氧化的切制铜台阶（竖直）").mineableWithPickaxe(BlockLib.LEVEL.STONE_TOOLS).slab().creativeTab(ModCreativeTabs.CREATIVE_MODE_TABS_BUILDINGS).complexCube());
            blockLib.add(new BlockLib(OXIDIZED_CUT_COPPER_UPRIGHT_STAIRS, "oxidized_cut_copper_upright_stairs").locale("Oxidized Cut Copper Upright Stairs", "氧化的切制铜楼梯（竖直）").mineableWithPickaxe(BlockLib.LEVEL.STONE_TOOLS).stairs().creativeTab(ModCreativeTabs.CREATIVE_MODE_TABS_BUILDINGS).complexCube());
            blockLib.add(new BlockLib(WEATHERED_CUT_COPPER_UPRIGHT_SLAB, "weathered_cut_copper_upright_slab").locale("Weathered Cut Copper Upright Slab", "锈蚀的切制铜台阶（竖直）").mineableWithPickaxe(BlockLib.LEVEL.STONE_TOOLS).slab().creativeTab(ModCreativeTabs.CREATIVE_MODE_TABS_BUILDINGS).complexCube());
            blockLib.add(new BlockLib(WEATHERED_CUT_COPPER_UPRIGHT_STAIRS, "weathered_cut_copper_upright_stairs").locale("Weathered Cut Copper Upright Stairs", "锈蚀的切制铜楼梯（竖直）").mineableWithPickaxe(BlockLib.LEVEL.STONE_TOOLS).stairs().creativeTab(ModCreativeTabs.CREATIVE_MODE_TABS_BUILDINGS).complexCube());
            blockLib.add(new BlockLib(EXPOSED_CUT_COPPER_UPRIGHT_SLAB, "exposed_cut_copper_upright_slab").locale("Exposed Cut Copper Upright Slab", "斑驳的切制铜台阶（竖直）").mineableWithPickaxe(BlockLib.LEVEL.STONE_TOOLS).slab().creativeTab(ModCreativeTabs.CREATIVE_MODE_TABS_BUILDINGS).complexCube());
            blockLib.add(new BlockLib(EXPOSED_CUT_COPPER_UPRIGHT_STAIRS, "exposed_cut_copper_upright_stairs").locale("Exposed Cut Copper Upright Stairs", "斑驳的切制铜楼梯（竖直）").mineableWithPickaxe(BlockLib.LEVEL.STONE_TOOLS).stairs().creativeTab(ModCreativeTabs.CREATIVE_MODE_TABS_BUILDINGS).complexCube());
            blockLib.add(new BlockLib(CUT_COPPER_UPRIGHT_SLAB, "cut_copper_upright_slab").locale("Cut Copper Upright Slab", "切制铜台阶（竖直）").mineableWithPickaxe(BlockLib.LEVEL.STONE_TOOLS).slab().creativeTab(ModCreativeTabs.CREATIVE_MODE_TABS_BUILDINGS).complexCube());
            blockLib.add(new BlockLib(CUT_COPPER_UPRIGHT_STAIRS, "cut_copper_upright_stairs").locale("Cut Copper Upright Stairs", "切制铜楼梯（竖直）").mineableWithPickaxe(BlockLib.LEVEL.STONE_TOOLS).stairs().creativeTab(ModCreativeTabs.CREATIVE_MODE_TABS_BUILDINGS).complexCube());
            blockLib.add(new BlockLib(WAXED_OXIDIZED_CUT_COPPER_UPRIGHT_SLAB, "waxed_oxidized_cut_copper_upright_slab").locale("Waxed Oxidized Cut Copper Upright Slab", "涂蜡的氧化切制铜台阶（竖直）").mineableWithPickaxe(BlockLib.LEVEL.STONE_TOOLS).slab().creativeTab(ModCreativeTabs.CREATIVE_MODE_TABS_BUILDINGS).complexCube());
            blockLib.add(new BlockLib(WAXED_OXIDIZED_CUT_COPPER_UPRIGHT_STAIRS, "waxed_oxidized_cut_copper_upright_stairs").locale("Waxed Oxidized Cut Copper Upright Stairs", "涂蜡的氧化切制铜楼梯（竖直）").mineableWithPickaxe(BlockLib.LEVEL.STONE_TOOLS).stairs().creativeTab(ModCreativeTabs.CREATIVE_MODE_TABS_BUILDINGS).complexCube());
            blockLib.add(new BlockLib(WAXED_WEATHERED_CUT_COPPER_UPRIGHT_SLAB, "waxed_weathered_cut_copper_upright_slab").locale("Waxed Weathered Cut Copper Upright Slab", "涂蜡的锈蚀切制铜台阶（竖直）").mineableWithPickaxe(BlockLib.LEVEL.STONE_TOOLS).slab().creativeTab(ModCreativeTabs.CREATIVE_MODE_TABS_BUILDINGS).complexCube());
            blockLib.add(new BlockLib(WAXED_WEATHERED_CUT_COPPER_UPRIGHT_STAIRS, "waxed_weathered_cut_copper_upright_stairs").locale("Waxed Weathered Cut Copper Upright Stairs", "涂蜡的锈蚀切制铜楼梯（竖直）").mineableWithPickaxe(BlockLib.LEVEL.STONE_TOOLS).stairs().creativeTab(ModCreativeTabs.CREATIVE_MODE_TABS_BUILDINGS).complexCube());
            blockLib.add(new BlockLib(WAXED_EXPOSED_CUT_COPPER_UPRIGHT_SLAB, "waxed_exposed_cut_copper_upright_slab").locale("Waxed Exposed Cut Copper Upright Slab", "涂蜡的斑驳切制铜台阶（竖直）").mineableWithPickaxe(BlockLib.LEVEL.STONE_TOOLS).slab().creativeTab(ModCreativeTabs.CREATIVE_MODE_TABS_BUILDINGS).complexCube());
            blockLib.add(new BlockLib(WAXED_EXPOSED_CUT_COPPER_UPRIGHT_STAIRS, "waxed_exposed_cut_copper_upright_stairs").locale("Waxed Exposed Cut Copper Upright Stairs", "涂蜡的斑驳切制铜楼梯（竖直）").mineableWithPickaxe(BlockLib.LEVEL.STONE_TOOLS).stairs().creativeTab(ModCreativeTabs.CREATIVE_MODE_TABS_BUILDINGS).complexCube());
            blockLib.add(new BlockLib(WAXED_CUT_COPPER_UPRIGHT_SLAB, "waxed_cut_copper_upright_slab").locale("Waxed Cut Copper Upright Slab", "涂蜡的切制铜台阶（竖直）").mineableWithPickaxe(BlockLib.LEVEL.STONE_TOOLS).slab().creativeTab(ModCreativeTabs.CREATIVE_MODE_TABS_BUILDINGS).complexCube());
            blockLib.add(new BlockLib(WAXED_CUT_COPPER_UPRIGHT_STAIRS, "waxed_cut_copper_upright_stairs").locale("Waxed Cut Copper Upright Stairs", "涂蜡的切制铜楼梯（竖直）").mineableWithPickaxe(BlockLib.LEVEL.STONE_TOOLS).stairs().creativeTab(ModCreativeTabs.CREATIVE_MODE_TABS_BUILDINGS).complexCube());
